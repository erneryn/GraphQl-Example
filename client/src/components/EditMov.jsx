...
import { ADD_MOVIE ,FETCH_MOVIES, UPDATE_MOVIE} from '../graphql/shemaMovies'


function EditMov({ data }) {
  ...
  const handleSubmit = () =>{
    updateMovie({variables: {_id:id,title,popularity: +popularity,poster_path,overview,tags}})
    setTags([])
    setShow(false)
  }
